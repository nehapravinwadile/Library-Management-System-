...
<div id="main">
  ...
  <div class="container">
    ...
    <form class="Approve" action="" method="post">
        ...
        <input type="text" name="return1" placeholder="Return Date yyyy-mm-dd" required="" class="form-control"><br>
...
<?php
  ...
  {
    mysqli_query($db,"UPDATE  `issue_book` SET  `approve` =  '$_POST[approve]', `issue` =  '$_POST[issue]', `return1` =  '$_POST[return1]' WHERE username='$_SESSION[name]' and bid='$_SESSION[bid]';");
